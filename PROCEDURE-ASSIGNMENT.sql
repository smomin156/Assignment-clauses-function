...
ALTER PROCEDURE CREATEEMP(@LNAME VARCHAR(20),@FNAME VARCHAR(20),@TITLE VARCHAR(20),@TCOURTEST VARCHAR(20),@BDATE DATETIME,@HIREDATE  DATETIME,@ADDRESS VARCHAR(20),@CITY VARCHAR(20),@REGION VARCHAR(20),@PCODE VARCHAR(20),@COUNTRY VARCHAR(10))AS
BEGIN
	BEGIN TRY
...
EXEC CREATEEMP 'MOMIN','SAMEERA','TRAINEE','MS.','1948-12-08','1992-05-01','722 Moss Bay Blvd.','MUMBAI','WA',98124,'INDIA'
...
BEGIN
	...
	END CATCH	
END
EXEC UPDATEEMP 10,'MOMIN','ASEER','MANAGER','MR','1948-12-08','1992-05-01','722 Moss Bay Blvd.','MUMBAI','WA',98124,'INDIA'
SELECT * FROM EMPLOYEES
